...
{
    $icons = [
        'car' => '<svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" aria-hidden="true"><path d="M4 11L5.5 6.5H18.5L20 11" stroke="#08284B" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round"/><path d="M4 11H20V16.5H18.25M5.75 16.5H4V11" stroke="#08284B" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round"/><circle cx="7.5" cy="16.5" r="1.75" stroke="#08284B" stroke-width="1.5"/><circle cx="16.5" cy="16.5" r="1.75" stroke="#08284B" stroke-width="1.5"/></svg>',
        ...
        'bus' => '<svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" aria-hidden="true"><rect x="7" y="5.5" width="10" height="11" rx="1.5" stroke="#08284B" stroke-width="1.5"/><path d="M7 10H17M9.5 5.5V3.75H14.5V5.5" stroke="#08284B" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round"/><circle cx="8.5" cy="17.5" r="1" fill="#08284B"/><circle cx="15.5" cy="17.5" r="1" fill="#08284B"/></svg>',
