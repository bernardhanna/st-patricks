...
require_once get_template_directory() . '/inc/locations-map-functions.php';
require_once get_template_directory() . '/inc/contact-directory-functions.php';
...
require_once get_template_directory() . '/inc/webinar-single-functions.php';
