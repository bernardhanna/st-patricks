...
$menus = [
    ...
    'Healthcare Professionals' => [
        ['Refer an Adult for Inpatient Care', $home . 'make-a-referral-cta/refer-an-adult-for-inpatient-care/'],
        ['Refer an Adolescent for Inpatient Care', $home . 'make-a-referral-cta/refer-an-adolescent-for-inpatient-care/'],
        ['Refer to the St Patrick\'s at Home Service', $home . 'make-a-referral-cta/refer-to-the-st-patricks-at-home-service/'],
        ['Refer to Outpatient Care', $home . 'make-a-referral-cta/refer-for-outpatient-care/'],
        ['Refer to a Day Programme', $home . 'make-a-referral-cta/refer-to-a-day-programme/'],
