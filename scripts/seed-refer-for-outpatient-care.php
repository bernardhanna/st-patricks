...
/**
 * Seed Refer for Outpatient Care (page 247) to match Figma frame 2888:3951.
 *
 * Run: wp eval-file wp-content/themes/matrix-starter/scripts/seed-refer-for-outpatient-care.php
 */

$post_id = (int) (get_page_by_path('healthcare-professionals/refer-for-outpatient-care')?->ID ?? 0);

if ($post_id === 0) {
    if (class_exists('WP_CLI')) {
        WP_CLI::error('Could not find page at healthcare-professionals/refer-for-outpatient-care.');
    }
...
$figma = [
    'video' => 'https://www.figma.com/api/mcp/asset/2a39fcd1-cc22-45ff-afc6-f78235d37fbf',
    'testimonials_bg' => 'https://www.figma.com/api/mcp/asset/42eb742a-d53c-42b5-b7e5-8725b83decfb',
    'location_1' => 'https://www.figma.com/api/mcp/asset/43b47bb6-81df-4f5b-b82c-2c001a3ed3ad',
    'location_2' => 'https://www.figma.com/api/mcp/asset/a17f840c-8b0f-4f4e-b5b4-049f93d4f7b5',
    'location_3' => 'https://www.figma.com/api/mcp/asset/4897e953-44d3-44bc-982d-3d034c82da0b',
    'location_4' => 'https://www.figma.com/api/mcp/asset/11eda753-3d8e-401d-98c2-91d5de61f468',
];

$video_poster_id = matrix_seed_resolve_image($figma['video'], 'refer-outpatient-video-2888-3951', 'Refer for outpatient care video');
$testimonials_bg_id = matrix_seed_resolve_image($figma['testimonials_bg'], 'refer-outpatient-testimonials-2888-3951', 'Refer for outpatient care testimonials background');
$location_image_ids = [
    matrix_seed_resolve_image($figma['location_1'], 'refer-outpatient-location-willow-grove-2888-3951', 'Willow Grove Adolescent Unit'),
    matrix_seed_resolve_image($figma['location_2'], 'refer-outpatient-location-spuh-2888-3951', 'St Patricks University Hospital'),
    matrix_seed_resolve_image($figma['location_3'], 'refer-outpatient-location-lucan-2888-3951', 'St Patricks Hospital Lucan'),
...
$flexi_rows = [
    [
        ...
        'current_crumb_label' => 'Refer to Outpatient Care',
        'heading_tag' => 'h1',
...
if (class_exists('WP_CLI')) {
    if ($saved_count === count($flexi_rows)) {
        WP_CLI::success(sprintf(
            'Seeded Refer for Outpatient Care page (%d) with %d flexi blocks.',
            $post_id,
            $saved_count
        ));
    } else {
