...
$post_id = (int) (get_page_by_path('make-a-referral/refer-for-outpatient-care')?->ID ?? 0);

if ($post_id === 0) {
    if (class_exists('WP_CLI')) {
        WP_CLI::error('Could not find page at make-a-referral/refer-for-outpatient-care.');
    }
