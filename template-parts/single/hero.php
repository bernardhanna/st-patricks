...
$back_label = (string) ($defaults['back_label'] ?? 'Back to blog');
$date_label = (string) ($defaults['date_label'] ?? 'Date posted:');
$blog_url = matrix_get_blog_index_url();
$intro = matrix_get_blog_post_intro();
?>
    ...
    <div class="mx-auto flex w-full max-w-[1018px] flex-col px-5 py-12 lg:px-0 lg:py-[100px]">
        ...
        <div class="mt-4 flex max-w-[800px] flex-col gap-4">
            ...
            <p class="font-primary text-[15px] font-semibold leading-[16px] tracking-[-0.09px] text-[#1E244B]">
                <?php echo esc_html($date_label); ?> <?php echo esc_html(matrix_format_blog_post_date()); ?>
            </p>
