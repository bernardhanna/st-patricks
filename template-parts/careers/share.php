...
$share_links = $post_id > 0 ? matrix_get_career_share_links($post_id) : [];

if ($share_links === []) {
    return;
}

$share_label = (string) $args['share_label'];
$copy_link_id = 'careers-share-copy-' . $post_id;
?>

<section class="bg-white">
    <div class="mx-auto flex w-full max-w-[1018px] flex-col px-5 pb-12 lg:px-0 lg:pb-[100px]">
        <div class="flex flex-col gap-4 border-y border-[#80CCD9] py-4 sm:flex-row sm:items-center">
