...
?>
<button id="backToTop"
  class="group flex fixed right-5 bottom-5 invisible justify-center items-center w-14 h-14 rounded-full border-2 opacity-0 transition duration-300 border-primary border-1">
  <svg width="52" height="52" viewBox="0 0 52 52" fill="none" xmlns="http://www.w3.org/2000/svg"
    ...
    <path d="M26 33V19M26 19L19 26M26 19L33 26" class="stroke-[#0B0B08] transition-colors group-hover:stroke-white" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" />
  </svg>
</button>
